function ethToIdenaUI() {
    ...
    document.getElementById("form-title").innerHTML = "Swap ERC20 iDNA to iDNA";
}
function idenaToEth() {
    ...
    document.getElementById("form-title").innerHTML = "Swap iDNA to ERC20 iDNA";
}
function createSwap() {
